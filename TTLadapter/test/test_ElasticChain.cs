...
{
    public class test_ElasticChain : GH_Component
    {
        ...
        /// </summary>
        public test_ElasticChain()
          : base("test_ElasticChain", "test_ElasticChain",
              "Simulation the deformation of an elastic over time",
			  "BHoM", "RDF_component")
        {
        }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("Achor1", "A1", "Second anchoir point", GH_ParamAccess.item);

            pManager.AddIntegerParameter("NodeCount", "NC", "Number of chain", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Schedule new autoupdate 
            if (autoupdate)
            {
                this.OnPingDocument().ScheduleSolution(millis, DocumentAngleTolerance =>
                {
        ...
        {
            get { return new Guid("951F2948-E921-4472-95E2-FA26FEB6A477"); }
        }
    }
}