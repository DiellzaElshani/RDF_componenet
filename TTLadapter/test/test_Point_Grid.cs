...
{
    public class test_Point_Grid : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the test2 class.
        /// </summary>
        public test_Point_Grid()
          : base("test_Point_Grid", "Point_Grid",
              "Description",
              "BHoM", "RDF_component")
        {
        }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("StepX", "DX", "Distance in X", GH_ParamAccess.item);
            pManager.AddNumberParameter("StepY", "DY", "Distance in Y", GH_ParamAccess.item);
        }
        ...
        {
            get { return new Guid("549BD881-0C5F-4957-97A7-9BF4FB9BB5A8"); }
        }
    }
}